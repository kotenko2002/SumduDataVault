    ...
    public static class CreateDataset
    {
        public class Endpoint : IEndpoint
        {
            ...
            )
            {
                ...
                var ds = mapper.Map<Dataset>((request, csvResult.Value, metadataResult.Value));
                context.Datasets.Add(ds);
                await context.SaveChangesAsync();

                var indexingResult = await IndexDatasetInOpenSearch(ds, openSearch, openSearchConfig.Value, mapper, logger);
                ...
                return Results.Created($"/datasets/{ds.Id}", new CreateDatasetResponse(ds.Id));
            }
